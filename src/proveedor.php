...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['nombre_corto'])) {
        ...
        $result = 0;
        if (empty($id)) {
            $query = mysqli_query($conexion, "SELECT * FROM sabor WHERE nombre = '$nombre'");
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO sabor(nombre, nombre_corto) values ('$nombre', '$nombre_corto')");
                if ($query_insert) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE sabor SET nombre = '$nombre', nombre_corto = '$nombre_corto' WHERE id = $id");
            if ($sql_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                        Sabor Modificado
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="tbl">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($conexion, "SELECT * FROM sabor");
