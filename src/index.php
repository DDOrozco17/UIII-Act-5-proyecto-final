            ...
            <div class="table-responsive">
                <table class="table table-danger table-bordered" id="tbl">
                    ...
                    <tbody>
                        ...
                        $hoy = date('Y-m-d');
                        $query = mysqli_query($conexion, "SELECT p.*, t.tipo, pr.nombre FROM productos p INNER JOIN marca t ON p.id_tipo = t.id INNER JOIN sabor pr ON p.id_presentacion = pr.id WHERE p.id_presentacion = '1'");
